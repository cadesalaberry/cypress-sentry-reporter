...
`cypress-sentry-reporter` follows [semantic versioning](https://semver.org).
...
1. Go to the **[Security](https://github.com/cadesalaberry/cypress-sentry-reporter/security)**
...
- We will keep you informed of progress toward a fix and may ask for more detail.
